...
void print_info(student head)//function to display the complete details of students along with complte details
{
  student stu_cur;
  
  printf("\n-------------------------------------------------\n");
  printf("               student information                   \n");
  printf("NAME   ID   STU_X   STU_Y  DIST_FROM_CENTRE CENTRE NAME CENTRE ID CENTRE_X CENTRE_Y\n");
...
int main()
{
 ...
 scanf("%d",&n);
 printf("Enter the details of students:\n");//details of students is taken as input
 input_student(n,head);
 printf("Enter the details of 3 study centres:\n");//details of study centre is taken as input
 input_centre(3,centre_head);
 printf("\n-------------------------------------------------------------\n");
 display(head);//display the details of students which was earlier taken as input
 printf("\n-------------------------------------------------------------\n");
 display_centre(centre_head);//display the details of study centr which was earlier taken as input
 printf("\n-------------------------------------------------------------\n");

 //printf("First iteration\n");
 allocation(head,centre_head);//allocation of study centre to students in the first round
 //allotment(head);
 
for(i=2;i<=10;i++)//recalculation of centroid and distance between students and thier study centre is calculated in 10 loops 
{
 ...
 printf("\nFINAL ALLOTMENT OF WITH COMPLETE DETAILS\n");
 print_info(head);
return (0);
}
